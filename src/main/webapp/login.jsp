    ...
    <body>
           ...
           <form  method="post" action="${path}/user/login.action" id="ff" style="top: 30%; left: 20%;position: absolute; ">
             ...
             <table>
                ...
                <tr><td style="text-align: right;padding-right: 15px">密码</td><td><input type="password"  class="easyui-validatebox"  data-options="required:true"  name="password"/>  </td></tr>
                ...
                <tr><td style="text-align: right;padding-right: 15px"></td><td><input type="checkbox" name="rememberMe" >记住我</td></tr>
