package cn.chouchou.config.quartz;
...
public class MyQuartzConfig {
     ...
     */  
    @Bean(name = "jobDetail")  
    public MethodInvokingJobDetailFactoryBean detailFactoryBean(Task1 task) {// ScheduleTask为需要执行的任务  
